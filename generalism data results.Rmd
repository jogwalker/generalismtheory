...
# New plots 18 July 2016: Combine endo and ecto and look at difference between direct and trophic
...
hp.direct <- generalism2 %>% filter(Complex == "No")
...
directlong2 %>% filter(index=="degree") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("degree") + stat_smooth(method="glm.nb")

directlong2 %>% filter(index=="G",length_measure!="CV host length") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("G") + stat_smooth(method="glm", method.args = list(family = "binomial"))
...
directlong2 %>% filter(index=="SPD") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("SPD") + stat_smooth(method="lm")

directlong2 %>% filter(index=="pd.obs.z") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("SES.PD") + stat_smooth(method="lm")
...
| PD | mean | `r round(coef(summary(directPD3))[2,1],digits=8)` |`r round(coef(summary(directPD3))[2,2],digits=8)` | `r round(confint(directPD3)[2,],digits=8)` | `r round(coef(summary(directPD3))[2,3],digits=8)` |
| PD | max | `r round(coef(summary(directPD2))[2,1],digits=8)` |`r round(coef(summary(directPD2))[2,2],digits=8)` | `r round(confint(directPD2)[2,],digits=8)` | `r round(coef(summary(directPD2))[2,3],digits=8)` |
| PD | CV | `r round(coef(summary(directPD1))[2,1],digits=8)` |`r round(coef(summary(directPD1))[2,2],digits=8)` | `r round(confint(directPD1)[2,],digits=8)` | `r round(coef(summary(directPD1))[2,3],digits=8)` |
...
trophiclong2 %>% filter(index=="degree") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("degree") + stat_smooth(method="glm.nb")

trophiclong2 %>% filter(index=="G",length_measure!="CV host length") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("G") + stat_smooth(method="glm", method.args = list(family = "binomial"))
...
trophiclong2 %>% filter(index=="SPD") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("SPD") + stat_smooth(method="lm")

trophiclong2 %>% filter(index=="pd.obs.z") %>% ggplot(data=.,aes(x=length,y=value)) + geom_jitter() + theme_bw() + facet_grid(~length_measure,scales="free") + ylab("SES.PD") + stat_smooth(method="lm")
...
| PD | mean | `r round(coef(summary(trophicPD3))[2,1],digits=8)` |`r round(coef(summary(trophicPD3))[2,2],digits=8)` | `r round(confint(trophicPD3)[2,],digits=8)` | `r round(coef(summary(trophicPD3))[2,3],digits=8)` |
| PD | max | `r round(coef(summary(trophicPD2))[2,1],digits=8)` |`r round(coef(summary(trophicPD2))[2,2],digits=8)` | `r round(confint(trophicPD2)[2,],digits=8)` | `r round(coef(summary(trophicPD2))[2,3],digits=8)` |
| PD | CV | `r round(coef(summary(trophicPD1))[2,1],digits=8)` |`r round(coef(summary(trophicPD1))[2,2],digits=8)` | `r round(confint(trophicPD1)[2,],digits=8)` | `r round(coef(summary(trophicPD1))[2,3],digits=8)` |
...
hp.geoDirect2 <- hp.geoDirect %>% filter(Complex == "No")
geoDlong <- hp.geoDirect2 %>% gather("index","value",c(16:19,25))
geoDlong %>% filter(!is.na(GEO)) %>% ggplot(data=.,aes(x=GEO,y=value,color=GeoGroup)) + geom_boxplot() + theme_bw() + facet_wrap(~index,scales="free") 
geoDlong %>% filter(!is.na(GeoGroup)) %>% ggplot(data=.,aes(x=GeoGroup,y=value,color=GeoGroup)) + geom_boxplot() + theme_bw() + facet_wrap(~index,scales="free") 
...
| PD |  `r round(coef(summary(geoPD2))[2,1],digits=8)` |`r round(coef(summary(geoPD2))[2,2],digits=8)` | `r round(confint(geoPD2)[2,],digits=8)` | `r round(coef(summary(geoPD2))[2,3],digits=8)` |
...
geoTlong <- hp.geoTrophic %>% gather("index","value",c(16:19,25))
...
| PD |  `r round(coef(summary(geoPD2T))[2,1],digits=8)` |`r round(coef(summary(geoPD2T))[2,2],digits=8)` | `r round(confint(geoPD2T)[2,],digits=8)` | `r round(coef(summary(geoPD2T))[2,3],digits=8)` |
