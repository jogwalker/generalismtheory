...
| Metric | Length Measure | Model Coefficient | Std Error |
|--------|-------------|-----------|-------|
| degree | mean | `r round(coef(summary(endoD3))[2,1],digits=5)` |`r round(coef(summary(endoD3))[2,2],digits=5)` |
| degree | max | `r round(coef(summary(endoD2))[2,1],digits=5)` |`r round(coef(summary(endoD2))[2,2],digits=5)` |
| degree | CV | `r round(coef(summary(endoD1))[2,1],digits=5)` |`r round(coef(summary(endoD1))[2,2],digits=5)` |
| G | mean | `r round(coef(summary(endoG3))[2,1],digits=5)` |`r round(coef(summary(endoG3))[2,2],digits=5)` |
| G | max | `r round(coef(summary(endoG2))[2,1],digits=5)` |`r round(coef(summary(endoG2))[2,2],digits=5)` |
| PD | mean | `r round(coef(summary(endoPD3))[2,1],digits=5)` |`r round(coef(summary(endoPD3))[2,2],digits=5)` |
| PD | max | `r round(coef(summary(endoPD2))[2,1],digits=5)` |`r round(coef(summary(endoPD2))[2,2],digits=5)` |
| PD | CV | `r round(coef(summary(endoPD1))[2,1],digits=5)` |`r round(coef(summary(endoPD1))[2,2],digits=5)` |
| SPD | mean | `r round(coef(summary(endoSPD3))[2,1],digits=5)` |`r round(coef(summary(endoSPD3))[2,2],digits=5)` |
| SPD | max | `r round(coef(summary(endoSPD2))[2,1],digits=5)` |`r round(coef(summary(endoSPD2))[2,2],digits=5)` |
| SPD | CV | `r round(coef(summary(endoSPD1))[2,1],digits=5)` |`r round(coef(summary(endoSPD1))[2,2],digits=5)` |
...
| Metric | Length Measure | Quartile (ref=1) | Model Coefficient | Std Error |
|--------|-------------|-----------|-------|--------|
| degree | mean | 2 | `r round(coef(summary(ectoD3))[2,1],digits=5)` |`r round(coef(summary(ectoD3))[2,2],digits=5)` |
| degree | mean | 3 | `r round(coef(summary(ectoD3))[3,1],digits=5)` |`r round(coef(summary(ectoD3))[3,2],digits=5)` |
| degree | mean | 4 | `r round(coef(summary(ectoD3))[4,1],digits=5)` |`r round(coef(summary(ectoD3))[4,2],digits=5)` |
| degree | max | 2 | `r round(coef(summary(ectoD2))[2,1],digits=5)` |`r round(coef(summary(ectoD2))[2,2],digits=5)` |
| degree | max | 3 | `r round(coef(summary(ectoD2))[3,1],digits=5)` |`r round(coef(summary(ectoD2))[3,2],digits=5)` |
| degree | max | 4 | `r round(coef(summary(ectoD2))[4,1],digits=5)` |`r round(coef(summary(ectoD2))[4,2],digits=5)` |
| degree | CV | 2 | `r round(coef(summary(ectoD1))[2,1],digits=5)` |`r round(coef(summary(ectoD1))[2,2],digits=5)` |
| degree | CV | 3 | `r round(coef(summary(ectoD1))[3,1],digits=5)` |`r round(coef(summary(ectoD1))[3,2],digits=5)` |
| degree | CV | 4 | `r round(coef(summary(ectoD1))[4,1],digits=5)` |`r round(coef(summary(ectoD1))[4,2],digits=5)` |
| G | mean | 2 | `r round(coef(summary(ectoG3))[2,1],digits=5)` |`r round(coef(summary(ectoG3))[2,2],digits=5)` |
| G | mean | 3 | `r round(coef(summary(ectoG3))[3,1],digits=5)` |`r round(coef(summary(ectoG3))[3,2],digits=5)` |
| G | mean | 4 | `r round(coef(summary(ectoG3))[4,1],digits=5)` |`r round(coef(summary(ectoG3))[4,2],digits=5)` |
| G | max | 2 | `r round(coef(summary(ectoG2))[2,1],digits=5)` |`r round(coef(summary(ectoG2))[2,2],digits=5)` |
| G | max | 3 | `r round(coef(summary(ectoG2))[3,1],digits=5)` |`r round(coef(summary(ectoG2))[3,2],digits=5)` |
| G | max | 4 | `r round(coef(summary(ectoG2))[4,1],digits=5)` |`r round(coef(summary(ectoG2))[4,2],digits=5)` |
| PD | mean | 2 | `r round(coef(summary(ectoPD3))[2,1],digits=5)` |`r round(coef(summary(ectoPD3))[2,2],digits=5)` |
| PD | mean | 3 | `r round(coef(summary(ectoPD3))[3,1],digits=5)` |`r round(coef(summary(ectoPD3))[3,2],digits=5)` |
| PD | mean | 4 | `r round(coef(summary(ectoPD3))[4,1],digits=5)` |`r round(coef(summary(ectoPD3))[4,2],digits=5)` |
| PD | max | 2 | `r round(coef(summary(ectoPD2))[2,1],digits=5)` |`r round(coef(summary(ectoPD2))[2,2],digits=5)` |
| PD | max | 3 | `r round(coef(summary(ectoPD2))[3,1],digits=5)` |`r round(coef(summary(ectoPD2))[3,2],digits=5)` |
| PD | max | 4 | `r round(coef(summary(ectoPD2))[4,1],digits=5)` |`r round(coef(summary(ectoPD2))[4,2],digits=5)` |
| PD | CV | 2 | `r round(coef(summary(ectoPD1))[2,1],digits=5)` |`r round(coef(summary(ectoPD1))[2,2],digits=5)` |
| PD | CV | 3 | `r round(coef(summary(ectoPD1))[3,1],digits=5)` |`r round(coef(summary(ectoPD1))[3,2],digits=5)` |
| PD | CV | 4 | `r round(coef(summary(ectoPD1))[4,1],digits=5)` |`r round(coef(summary(ectoPD1))[4,2],digits=5)` |
| SPD | mean | 2 | `r round(coef(summary(ectoSPD3))[2,1],digits=5)` |`r round(coef(summary(ectoSPD3))[2,2],digits=5)` |
| SPD | mean | 3 | `r round(coef(summary(ectoSPD3))[3,1],digits=5)` |`r round(coef(summary(ectoSPD3))[3,2],digits=5)` |
| SPD | mean | 4 | `r round(coef(summary(ectoSPD3))[4,1],digits=5)` |`r round(coef(summary(ectoSPD3))[4,2],digits=5)` |
| SPD | max | 2 | `r round(coef(summary(ectoSPD2))[2,1],digits=5)` |`r round(coef(summary(ectoSPD2))[2,2],digits=5)` |
| SPD | max | 3 | `r round(coef(summary(ectoSPD2))[3,1],digits=5)` |`r round(coef(summary(ectoSPD2))[3,2],digits=5)` |
| SPD | max | 4 | `r round(coef(summary(ectoSPD2))[4,1],digits=5)` |`r round(coef(summary(ectoSPD2))[4,2],digits=5)` |
| SPD | CV | 2 | `r round(coef(summary(ectoSPD1))[2,1],digits=5)` |`r round(coef(summary(ectoSPD1))[2,2],digits=5)` |
| SPD | CV | 3 | `r round(coef(summary(ectoSPD1))[3,1],digits=5)` |`r round(coef(summary(ectoSPD1))[3,2],digits=5)` |
| SPD | CV | 4 | `r round(coef(summary(ectoSPD1))[4,1],digits=5)` |`r round(coef(summary(ectoSPD1))[4,2],digits=5)` |
...
geoDlong %>% filter(!is.na(GEO)) %>% ggplot(data=.,aes(x=GEO,y=value,color=GeoGroup)) + geom_violin() + theme_bw() + facet_wrap(~index,scales="free") 
geoDlong %>% filter(!is.na(GeoGroup)) %>% ggplot(data=.,aes(x=GeoGroup,y=value,color=GeoGroup)) + geom_violin() + theme_bw() + facet_wrap(~index,scales="free")
...
| Metric | Model Coefficient (ref="warm") | Std Error |
|--------|-----------|-------|
| degree |  `r round(coef(summary(geoD2))[2,1],digits=5)` |`r round(coef(summary(geoD2))[2,2],digits=5)` |
| G |  `r round(coef(summary(geoG2))[2,1],digits=5)` |`r round(coef(summary(geoG2))[2,2],digits=5)` |
| PD |  `r round(coef(summary(geoPD2))[2,1],digits=5)` |`r round(coef(summary(geoPD2))[2,2],digits=5)` |
| SPD |  `r round(coef(summary(geoSPD2))[2,1],digits=5)` |`r round(coef(summary(geoSPD2))[2,2],digits=5)` |
